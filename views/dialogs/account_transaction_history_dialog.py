"""
Account Transaction History Dialog - Simple transaction editing for savings accounts
"""
...
class AccountTransactionHistoryDialog(QDialog):
    """Dialog for editing savings account transactions - simplified approach"""

    account_updated = pyqtSignal(object)  # Signal when account is modified
    ...
    def init_ui(self):
        """Initialize the UI - Simple transaction table"""
        layout = QVBoxLayout()
    ...
    def load_transactions(self):
        """Load all transactions for this account - store transaction IDs for editing"""
        try:
